        ...
        #
            ...
            # Pre-made attention maps = False 
                ...
                with tf.variable_scope("readout"):
                    ...
                    print('feature_map_in_seqs', feature_map_in_seqs)
                ...
                predicted_gazemaps = tf.random_normal([batch_size_tensor * n_steps_tensor, h, w, 1])  # (-1, 9, 16, 1)
                attention_logits = tf.random_normal([batch_size_tensor * n_steps_tensor, h * w])  # (-1, 144)
