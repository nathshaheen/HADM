...
# dataset='training' | "validation" batch_size=--batch_size=3 n_steps=--n_steps=20, shuffle=True, include_labels=True n_epochs=--epochs_before_validation=1
def input_fn(dataset, batch_size, n_steps, shuffle, include_labels, n_epochs, args, weight_data=False, augment_data=False):
  ...
  dataset = files.apply(tf.contrib.data.parallel_interleave(
    # num_parallel=10 batch_size=--batch_size=3
